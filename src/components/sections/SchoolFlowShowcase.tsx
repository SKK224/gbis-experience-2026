import SchoolFlowPreview from "@/components/products/SchoolFlowPreview";
import Button from "@/components/ui/Button";

const benefits = [
  "Centraliser les informations des élèves",
  "Suivre les présences, notes et paiements",
  "Réduire les erreurs administratives",
  "Améliorer le pilotage de l’établissement",
];
...
export default function SchoolFlowShowcase() {
  return (
    <section
      id="schoolflow"
      ...
      <div className="relative mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="animate-gbis-fade-up animation-delay-300 mt-5 text-xl font-semibold text-slate-800 sm:text-2xl">
            La gestion scolaire moderne, simple et centralisée.
          </p>

          <p className="animate-gbis-fade-up animation-delay-500 mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-600">
            SchoolFlow aide les établissements à gérer les élèves, les
            présences, les résultats scolaires et les paiements depuis une
            seule plateforme.
          </p>
